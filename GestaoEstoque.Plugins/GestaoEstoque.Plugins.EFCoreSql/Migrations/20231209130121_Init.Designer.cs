...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GestaoEstoque.CoreBusiness.Inventory", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            InventoryId = 4,
                            InventoryName = "Bike Pedel",
                            Price = 1.0,
                            Quantity = 40
                        });
                });

            modelBuilder.Entity("GestaoEstoque.CoreBusiness.InventoryTransaction", b =>
                {
            ...
            modelBuilder.Entity("GestaoEstoque.CoreBusiness.Product", b =>
                {
            ...
            modelBuilder.Entity("GestaoEstoque.CoreBusiness.ProductInventory", b =>
                {
                    b.Property<int>("ProductId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GestaoEstoque.CoreBusiness.ProductTransaction", b =>
                {
            ...
            modelBuilder.Entity("GestaoEstoque.CoreBusiness.InventoryTransaction", b =>
                {
                    b.HasOne("GestaoEstoque.CoreBusiness.Inventory", "Inventory")
                        .WithMany()
            ...
            modelBuilder.Entity("GestaoEstoque.CoreBusiness.ProductInventory", b =>
                {
                    ...
                    b.HasOne("GestaoEstoque.CoreBusiness.Product", "Product")
                        .WithMany("ProductInventories")
