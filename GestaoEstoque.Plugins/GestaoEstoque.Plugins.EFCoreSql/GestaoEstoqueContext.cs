    ...
    public class GestaoEstoqueContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Inventory>().HasData(
                    ...
                    new Inventory() { InventoryId = 1, InventoryName = "Bike Seat", Quantity = 20, Price = 2 },
                    new Inventory() { InventoryId = 2, InventoryName = "Bike Body", Quantity = 30, Price = 15 },
                    new Inventory() { InventoryId = 3, InventoryName = "Bike Wheel", Quantity = 10, Price = 8 },
                    new Inventory() { InventoryId = 4, InventoryName = "Bike Pedel", Quantity = 40, Price = 1 }
                );
